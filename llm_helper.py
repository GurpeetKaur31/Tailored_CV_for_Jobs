...
Based on the following original resume and job description, generate a tailored resume that highlights relevant skills, experiences, and qualifications aligning with the job requirements.txt. Ensure that the tailored resume:
